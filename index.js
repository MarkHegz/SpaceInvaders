...
class Projectile {
    constructor({position, velocity, color = 'rgb(3, 252, 140)'}){
...
function createScoreLabel({score = 100, object}) {
    ...
    function rectangularCollision({ rectangle1, rectangle2 }) {
        ...
        rectangle1.height >= rectangle2.position.y &&
        rectangle1.position.x + 
        rectangle1.width >= rectangle2.position.x &&
